...
from lge_cnn.nn.models import GCMConvNet, BaselineNet
...
def train(hparams):
    ...
    for num in range(hparams.num_models):
        ...
        if not hparams.no_early:
            ...
            trainer = pl.Trainer.from_argparse_args(hparams, weights_summary='full')
...
if __name__ == '__main__':
    ...
    parser = GCMConvNet.add_model_specific_args(parser)
